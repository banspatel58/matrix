...
def find_num_decode_ways(s: str) -> int:
    if not s or s[0] == '0':
        return 0
    ...
    for i in range(2, n + 1):
        ...
        if 10 <= two_digit <= 26:
            dp[i] += dp[i -2]
    print("Number of ways string " + s + " can be decoded is: " + str(dp))
    return dp[n]

if __name__ == '__main__':
    find_num_decode_ways("22501")
    find_num_decode_ways("12345")
    find_num_decode_ways("246820")
